...
class Charset {
  ...
  private final Map<Integer, BufferedImage> map1 = new HashMap<>();
  private final Map<Integer, ImageIcon> map2 = new HashMap<>();
  private final Map<Integer, BufferedImage> bufferedImageMap16x16 = new HashMap<>();
  private final Map<Integer, ImageIcon> imageIconMap16x16 = new HashMap<>();
